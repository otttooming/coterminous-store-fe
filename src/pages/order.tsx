        ...
        <div className="col-xs-12 grid_content with-sidebar-top cfx">
          <div className>
            <div className="woocommerce">
              ...
              <div className="bg__common p1 mb1">
                <p>
                  Maksmiseks saate teha pangaülekande meie kontole. Palun
                  kasutage oma tellimuse ID numbrit makse selgituseks. Teie
                  tellimust ei saadeta enne makse sooritamist.
                </p>
                <section className="woocommerce-bacs-bank-details">
                  <h2 className="wc-bacs-bank-details-heading">
                    Meie panga andmed
                  </h2>
